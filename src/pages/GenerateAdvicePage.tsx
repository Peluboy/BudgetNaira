...
import GenerateAdviceForm from '../components/finance/GenerateAdviceForm';

const GenerateAdvicePage = () => {
    ...
    return (
      <div className="bg-white p-8 rounded-lg shadow-sm">
        ...
        <p className="text-gray-600 mb-6">
          To receive personalized financial advice, we need to understand your financial situation, goals, and preferences.
        </p>
        <button 
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-800">Generate Financial Advice</h1>
        <p className="text-gray-500">
          Get personalized financial guidance based on your profile and Nigerian economic conditions
        </p>
      </div>
...
export default GenerateAdvicePage;